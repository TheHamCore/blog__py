...
class Post(models.Model):
    ...
    slug = models.SlugField(max_length=250, unique_for_date='publish')  # для url(уникальных)
    ...
    status = models.CharField(max_length=10, choices=STATUS_CHOICES, default='draft')  # cтатус статьи
